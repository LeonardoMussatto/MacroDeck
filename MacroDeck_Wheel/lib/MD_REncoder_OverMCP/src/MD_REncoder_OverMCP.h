...
*/
#ifndef _MD_RENCODER_MCP_H
#define _MD_RENCODER_MCP_H

#include <Adafruit_MCP23X08.h>
#include <Arduino.h>
/**
 * \file
 * \brief Main header file for the MD_Rencoder_OverMCP library
 */
...
public:
   ...
   */
  MD_REncoder_MCP(uint8_t pinA, uint8_t pinB);
   ...
   * \param mcp reference to Adafruit_MCP3X08 instance
   */
  void begin(Adafruit_MCP23X08 &mcp);
   ...
   */
  uint8_t read(Adafruit_MCP23X08 &mcp);
